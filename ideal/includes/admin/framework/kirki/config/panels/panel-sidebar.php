...
Kirki::add_field( $config_id, [
  ...
  'label'       => esc_html__( 'Blog Sidebar' , 'ideal' ),
  'description' => esc_html__( 'Switch To Enable Blog Sidebar, this option will enable blog sidebar if is on' , 'ideal' ),
...
Kirki::add_field( $config_id, [
  ...
  'label'       => esc_html__( 'Page Sidebar' , 'ideal' ),
  'description' => esc_html__( 'this option will enable Page sidebar if is on' , 'ideal' ),
	'section'     => 'sidebar_settings_options',
	'default'     =>true,
	'priority'    => 2,
	'choices'     => [
