...
$ideal_menu_icon = null;
 ...
 $args = array(
  ...
  'templates_path' =>  get_template_directory() . '/includes/admin/redux-framework/ReduxCore/templates/panel/',
  'dev_mode'         => false,
...
if(!function_exists('redux_register_custom_extension_loader')) :
  ...
  function redux_register_custom_extension_loader($ReduxFramework) {
      ...
      $path = get_parent_theme_file_path('/includes/admin/redux-framework/extensions/');
...
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/option-general.php';
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/option-typography.php';    
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/option-header.php';
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/options-page-header.php';
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/option-sidebar.php';
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/option-blog.php';
include_once IDEAL_THEME_DIRECTORY .'/includes/admin/options/option-page.php';
