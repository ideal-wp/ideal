...
if (!empty($ideal_options['style-dynamic-load']) && $ideal_options['style-dynamic-load'] == 2 ){
  ...
  if ($ideal_options['force-dynamic-cache'] == 1 ){
...
if ( ! empty($ideal_options['minify-dynamic-allow']) && $ideal_options['minify-dynamic-allow'] == 1 ){
...
/**
 * 
 * checking the user permission to write the file if is enable by ideal redux options
 * to write or not 
 */

if ( ! empty($ideal_options['shutdown-dynamic-file']) && $ideal_options['shutdown-dynamic-file'] == 1 ){

  remove_action( 'ideal_off_write', 'ideal_generate_file_css', 1 );

}elseif( ! empty($ideal_options['shutdown-dynamic-file']) && $ideal_options['shutdown-dynamic-file'] == 0 &&
