...
if (!class_exists('ReduxFramework') && file_exists(IDEAL_THEME_DIRECTORY . '/includes/admin/framework/ReduxCore/framework.php')) {
...
if (!isset($redux_demo) && file_exists(IDEAL_THEME_DIRECTORY . '/includes/admin/framework/config/options-config.php')) {

    require_once IDEAL_THEME_DIRECTORY . '/includes/admin/framework/config/options-config.php';

    require_once IDEAL_THEME_DIRECTORY . '/includes/admin/framework/extensions.php';
}
